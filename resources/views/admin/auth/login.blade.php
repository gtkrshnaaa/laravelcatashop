...
<head>
    ...
    <title>Admin Login - LaravelCataShop</title>
    <script>
...
<body class="bg-background text-primary min-h-screen flex items-center justify-center p-4 transition-colors duration-300">
    ...
    <div class="w-full max-w-md bg-surface border border-border p-8 rounded-xl shadow-2xl">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-primary mb-2">Admin Login</h1>
            <p class="text-secondary text-sm">LaravelCataShop Admin Panel</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
            ...
            <div class="flex items-center">
                <input id="remember" type="checkbox" name="remember" class="rounded border-border text-primary focus:ring-primary">
